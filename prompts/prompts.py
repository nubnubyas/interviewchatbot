class templates:
    ...
    noc_template = """
            ...
            Based on the Resume, 
            Create a guideline with followiing topics for an interview to test the knowledge of the candidate on necessary skills for the applicant to be suitable for
            embarking on the NUS Overseas College Program.
